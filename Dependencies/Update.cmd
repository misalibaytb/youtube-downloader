...
echo.
ping localhost -n 2 >nul
@REM create shortcut to %appdata%/Youtube-Downloader/start.cmd and %appdata%/Youtube-Downloader/uninstall.cmd with icon from %appdata%/Youtube-Downloader/icon.ico with run in %appdata%/Youtube-Downloader
